...
const Notesblock = ({ note }: Props) => {
  ...
  return (
    <>
      ...
      <div
        className="h-40 md:h-80 bg-[#ffffffee] text-black rounded-2xl border-t-10 border-amber-400 p-4 overflow-hidden hover:scale-105 transform-all duration-300 ease-in-out"
        style={{
